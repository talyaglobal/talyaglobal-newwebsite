// Supabase configuration following TalyaGlobal standards
// Using REST API connections (fetch, not SDK) as per requirements
...
// Base API client following REST API standards
...
export const apiClient = new ApiClient(envConfig.supabaseUrl, envConfig.supabaseAnonKey)
